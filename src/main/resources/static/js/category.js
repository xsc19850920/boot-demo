...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '菜单ID', field: 'categoryId', visible: false, align: 'center', valign: 'middle', width: '80px'},
        {title: '标题名称', field: 'title', align: 'center', valign: 'middle', sortable: true, width: '180px'},
        {title: '二级标题名称', field: 'subTitle', align: 'center', valign: 'middle', sortable: true, width: '180px'},
...
$(function () {
    ...
    var table = new TreeTable(Menu.id, baseURL + "category_list", colunms);
